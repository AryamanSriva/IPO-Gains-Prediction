...
def main():
    ...
    excel_file = "IPOs.xlsx"  # Replace with your file path
    ...
    print("report = pipeline.run_complete_pipeline('IPOs.xlsx')")
    
    # Run the pipeline right away to build the model!
    print("\n\n--- RUNNING PIPELINE NOW ---")
    pipeline.run_complete_pipeline(excel_file)
